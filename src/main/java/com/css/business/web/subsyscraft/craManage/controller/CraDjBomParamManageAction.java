...
import com.css.business.web.subsyscraft.craManage.service.CraDjBomParamManageService;
...
@Controller
@RequestMapping("/craDjBomParamManageAction")
public class CraDjBomParamManageAction extends BaseSpringSupportAction<CraDjBomParam, CraDjBomParamManageService> {
	
	//@Autowired
	private CraDjBomParamManageService service;
	
	@Override
	public CraDjBomParamManageService getEntityManager() {
		return service;
	}

	public CraDjBomParamManageService getService() {
		return service;
	}

	@Resource(name="craDjBomParamManageService")
	public void setService(CraDjBomParamManageService service) {
	...
	public String toListPage(HttpServletRequest request, Integer id,String proGgxh,Integer flag,String seqName){
		...
		return "craManage/seqBomParam/djTable";
	}
	...
	public HashMap<String, Object>saveOrUpdateBean(HttpServletRequest request,String bean){
		try {
			...
			service.saveOrUpdateBean((List<CraDjBomParam>)gson.fromJson(decode, new TypeToken<List<CraDjBomParam>>(){}.getType()),SessionUtils.getUser(request).getAccount());
		} catch (Exception e) {
			e.printStackTrace();
	...
	public HashMap<String, Object>getByProGgxh(HttpServletRequest request,String proGgxh,String seqStep){
		CraDjBomParam craDjBomParam = service.getByProGgxh(proGgxh,seqStep);
		if (craDjBomParam != null) {
			return JsonWrapper.successWrapper(craDjBomParam);
		} else {
			return JsonWrapper.failureWrapper(craDjBomParam);
		}
	}
