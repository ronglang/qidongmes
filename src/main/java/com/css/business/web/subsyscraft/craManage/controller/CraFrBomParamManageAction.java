...
import com.css.business.web.subsyscraft.craManage.service.CraFrBomParamManageService;
...
@Controller
@RequestMapping("/craFrBomParamManageAction")
public class CraFrBomParamManageAction extends BaseSpringSupportAction<CraFrBomParam, CraFrBomParamManageService> {
	
	//@Autowired
	private CraFrBomParamManageService service;
	
	@Override
	public CraFrBomParamManageService getEntityManager() {
		return service;
	}

	public CraFrBomParamManageService getService() {
		return service;
	}

	@Resource(name="craFrBomParamManageService")
	public void setService(CraFrBomParamManageService service) {
	...
	public String toListPage(HttpServletRequest request, Integer id,String proGgxh,Integer flag,String seqName){
		...
		return "craManage/seqBomParam/frTable";
	}
	...
	public HashMap<String, Object>saveOrUpdateBean(HttpServletRequest request,String bean){
		try {
			...
			service.saveOrUpdateBean((List<CraFrBomParam>)gson.fromJson(decode, new TypeToken<List<CraFrBomParam>>(){}.getType()),SessionUtils.getUser(request).getAccount());
		} catch (Exception e) {
			e.printStackTrace();
	...
	public HashMap<String, Object>getByProGgxh(HttpServletRequest request,String proGgxh,String seqStep){
		CraFrBomParam craFrBomParam = service.getByProGgxh(proGgxh,seqStep);
		if (craFrBomParam != null) {
			return JsonWrapper.successWrapper(craFrBomParam);
		} else {
			return JsonWrapper.failureWrapper(craFrBomParam);
		}
	}
