...
import com.css.business.web.subsyscraft.craManage.service.CraJjBomParamManageService;
...
@Controller
@RequestMapping("/craJjBomParamManageAction")
public class CraJjBomParamManageAction extends BaseSpringSupportAction<CraJjBomParam, CraJjBomParamManageService> {
	
	//@Autowired
	private CraJjBomParamManageService service;
	
	@Override
	public CraJjBomParamManageService getEntityManager() {
		return service;
	}

	public CraJjBomParamManageService getService() {
		return service;
	}

	@Resource(name="craJjBomParamManageService")
	public void setService(CraJjBomParamManageService service) {
	...
	public String toListPage(HttpServletRequest request, Integer id,String proGgxh,Integer flag,String seqName){
		...
		return "craManage/seqBomParam/jjTable";
	}
	...
	public HashMap<String, Object>saveOrUpdateBean(HttpServletRequest request,String bean){
		try {
			...
			service.saveOrUpdateBean((List<CraJjBomParam>)gson.fromJson(decode, new TypeToken<List<CraJjBomParam>>(){}.getType()),SessionUtils.getUser(request).getAccount());
		} catch (Exception e) {
			e.printStackTrace();
	...
	public HashMap<String, Object>getByProGgxh(HttpServletRequest request,String proGgxh,String seqStep){
		CraJjBomParam craJjBomParam = service.getByProGgxh(proGgxh,seqStep);
		if (craJjBomParam != null) {
			return JsonWrapper.successWrapper(craJjBomParam);
		} else {
			return JsonWrapper.failureWrapper(craJjBomParam);
		}
	}
