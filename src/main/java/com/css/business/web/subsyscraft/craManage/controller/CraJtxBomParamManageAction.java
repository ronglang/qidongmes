...
import com.css.business.web.subsyscraft.craManage.service.CraJtxBomParamManageService;
...
@Controller
@RequestMapping("/craJtxBomParamManageAction")
public class CraJtxBomParamManageAction extends BaseSpringSupportAction<CraJtxBomParam, CraJtxBomParamManageService> {
	
	//@Autowired
	private CraJtxBomParamManageService service;
	
	@Override
	public CraJtxBomParamManageService getEntityManager() {
		return service;
	}

	public CraJtxBomParamManageService getService() {
		return service;
	}

	@Resource(name="craJtxBomParamManageService")
	public void setService(CraJtxBomParamManageService service) {
	...
	public String toListPage(HttpServletRequest request, Integer id,String proGgxh,Integer flag,String seqName){
		...
		return "craManage/seqBomParam/jtxTable";
	}
	...
	public HashMap<String, Object>saveOrUpdateBean(HttpServletRequest request,String bean){
		try {
			...
			service.saveOrUpdateBean((List<CraJtxBomParam>)gson.fromJson(decode, new TypeToken<List<CraJtxBomParam>>(){}.getType()),SessionUtils.getUser(request).getAccount());
		} catch (Exception e) {
			e.printStackTrace();
	...
	public HashMap<String, Object>getByProGgxh(HttpServletRequest request,String proGgxh,String seqStep){
		CraJtxBomParam craJtxBomParam = service.getByProGgxh(proGgxh,seqStep);
		if (craJtxBomParam != null) {
			return JsonWrapper.successWrapper(craJtxBomParam);
		} else {
			return JsonWrapper.failureWrapper(craJtxBomParam);
		}
	}
