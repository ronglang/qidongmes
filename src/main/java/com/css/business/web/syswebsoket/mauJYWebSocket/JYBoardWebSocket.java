 ...
 * @company SMTC
 */
@ServerEndpoint(value = "/JYBoardWebSocket", configurator = GetHttpSessionConfigurator.class)
public class JYBoardWebSocket {
	// 刷新条件判断
	...
	private boolean getflag() {
		...
		String cache = cacheFactory
				.getWebsocketCmdCache(YorkUtil.Memcache_看板_绝缘_实时);
		if (cache != null && cache != "") {
			...
			cacheFactory
			.removeWebsocketCmdCache(YorkUtil.Memcache_看板_绝缘_实时);
			return true;
		}
		return false;
	}
