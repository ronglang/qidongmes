 ...
 * 
 */
@ServerEndpoint(value = "/productDepartmentPineWebSocket", configurator = GetHttpSessionConfigurator.class)
public class ProductDepartmentPineWebSocket {
	...
	private boolean getFlag() {
		...
		String cache = cacheFactory
				.getWebsocketCmdCache(YorkUtil.Memcache_看板_生产_饼);
		if (cache != null && cache != "") {
