...
/**
 * 
* @Title: DiskExceptionWebSocket.java   
* @Package com.css.business.web.syswebsoket.maudiskpartwebsocket   
* @Description: 分盘异常电子看板的websocket
* @author   rb
* @date 2017年7月23日 下午6:51:59   
* @company  SMTC
 */

public class DiskExceptionWebSocket {
	public String text;
...
//				text = gson.toJson(mauException);
	...
	@OnClose
	public void onClose() {
		System.out.println("分盘异常webSocket  Connection closed");
	}
