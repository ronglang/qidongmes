...
/**
 * 
 * TODO  JDBC操作元数据示例-- DatabaseMetaData接口
 * @author huanghao
 * 2015年8月3日下午12:58:31
 */
...
//    private static String PASS = "root"; 
	 ...
	 private static String DRIVER = "net.sourceforge.jtds.jdbc.Driver";  
	    private static String URL = "jdbc:jtds:sqlserver://124.161.245.133;databasename=yaecpdb;SelectMethod=cursor";  
	    private static String USER = "sa";  
	    private static String PASS = "yaanyj123456"; 
   ...
   //获取数据库相关信息
    ...
    try{
     ...
     // ((OracleConnection)conn).setRemarksReporting(true); 
       ...
       */
      rs =dbmd.getColumns(null, null, "RES_LED", null);
      ...
      while(rs.next()){
        String tableCat = rs.getString("TABLE_CAT");  //表类别（可能为空）                  
                ...
                System.out.println(tableCat + " - " + tableSchemaName + " - " + tableName_ + " - columnName:" + columnName + 
                		" - " + dataType + " - " + dataTypeName + " - " + columnSize + " - " + decimalDigits + " - " 
                		+ numPrecRadix + " - " + nullAble + " - remarks:" + remarks + " - " + columnDef + " - " + charOctetLength
