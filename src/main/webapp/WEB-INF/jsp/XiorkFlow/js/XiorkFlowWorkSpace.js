...
//
XiorkFlowWorkSpace.BASE_PATH = "/xzsp/";
...
XiorkFlowWorkSpace.URL_ADD_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "workflow/wf_addprocess.action";
XiorkFlowWorkSpace.URL_DELETE_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "workflow/wf_deleteprocess.action";
XiorkFlowWorkSpace.URL_GET_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "workflow/wf_getprocess.action";
XiorkFlowWorkSpace.URL_LIST_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "workflow/wf_listprocess.action";
XiorkFlowWorkSpace.URL_UPDATE_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "workflow/wf_updateprocess.action";
