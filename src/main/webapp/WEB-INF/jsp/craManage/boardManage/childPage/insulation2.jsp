...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<%=basePath%>core/css/board/insulation2.css"/>
  ...
  <body>
		...
		<script type="text/javascript" src="<%=basePath%>core/js/board/insulation2.js" ></script>
	</body>
</html>
