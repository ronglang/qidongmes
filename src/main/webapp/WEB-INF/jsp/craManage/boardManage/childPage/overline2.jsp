  ...
  <body>
		...
		<div id="contentimg">
			<div class="left" style="width:100%">
				...
				-->
				<div class="divbottom" id="bottomimg" style="width: 750px; height: 350px; margin:0 auto;margin-top: 9px;">
		...
		<script type="text/javascript" src="<%=basePath%>core/js/board/overline2.js" ></script>
