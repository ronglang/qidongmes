		...
		<div id="content">
			...
			<table border="0" cellpadding="0" cellspacing="0" id="tbs1">
				 ...
				 <tr>
					<td>
						<span>1#包带头包向：</span>
						<label id="5000">暂无数据</label>
					</td>
					<td>
						<span>2#包带头包向：</span>
						<label id="5001">暂无数据</label>
					</td>
					<td>
						<span>3#包带头包向：</span>
						<label id="5002">暂无数据</label>
					</td>
					<td>
						<span>1#包带头节距：</span>
						<label id="5003">暂无数据</label>
					</td>
				</tr>
				<tr>
					<td>
						<span>2#包带头节距：</span>
						<label id="5004">暂无数据</label>
					</td>
					<td>
						<span>3#包带头节距：</span>
						<label id="5005">暂无数据</label>
					</td>
					<td>
						<span>1#包带头覆盖率：</span>
						<label id="5006">暂无数据</label>
					</td>
					<td>
						<span>2#包带头覆盖率：</span>
						<label id="5007">暂无数据</label>
					</td>
				</tr>
				<tr>
					<td>
						<span>3#包带头覆盖率：</span>
						<label id="5008">暂无数据</label>
					</td>
					<td>
						<span>1#包带头转速：</span>
						<label id="5009">暂无数据</label>
					</td>
					<td>
						<span>2#包带头转速：</span>
						<label id="5010">暂无数据</label>
					</td>
					<td>
						<span>3#包带头转速：</span>
						<label id="5011">暂无数据</label>
					</td>
				</tr>
				<tr>
					<td>
						<span>平均出线速度：</span>
						<label id="5012">暂无数据</label>
					</td>
					<td>
						<span>最大出线速度：</span>
						<label id="5013">暂无数据</label>
					</td>
					<td>
						<span>生产长度：</span>
						<label id="5014">暂无数据</label>
					</td>
					<td>
						<span>总电能：</span>
