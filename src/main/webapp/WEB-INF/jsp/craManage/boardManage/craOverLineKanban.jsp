...
<script type="text/javascript">
  ...
  <body>
		...
		<iframe id="one" name="toppage" width=100% height=100% marginwidth=0 marginheight=0 frameborder="no" border="0" scrolling="no"  src="<%=basePath%>rest/overLine/toLineOne?requestType=mapuser" >
					
		</iframe>
		
		<iframe id="two" name="toppage" width=100% height=100% marginwidth=0 marginheight=0 frameborder="no" border="0" scrolling="no"  src="<%=basePath%>rest/overLine/toLineTwo?requestType=mapuser" >
		...
		<script type="text/javascript">
			...
			function webSockets(){
			    ...
			    if ('WebSocket' in window) {
					var url = "ws://"+urlPath+"CLExceptionWebSocket";
