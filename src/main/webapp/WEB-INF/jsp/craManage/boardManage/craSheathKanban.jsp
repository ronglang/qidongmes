...
<html>
  ...
  <body>
		...
		<div id="main">
			<div class="first">
				<iframe name="toppage" width=100% height=100% marginwidth=0 marginheight=0 frameborder="no" border="0" scrolling="no"  src="<%=basePath%>rest/sheathboard/sheathone?requestType=mapuser" >
					
				</iframe>
			</div>
			<div class="two">
				<iframe name="toppage" width=100% height=100% marginwidth=0 marginheight=0 frameborder="no" border="0" scrolling="no" src="<%=basePath%>rest/sheathboard/sheathtwo?requestType=mapuser" ></iframe>
			</div>
...
//			  },5000);
		...
		function webSockets(){
		    ...
		    if ('WebSocket' in window) {
				var url = "ws://"+urlPath+"JHTExceptionWebSocket";
