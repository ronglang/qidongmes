...
<html>
  ...
  <body>
		<div id="one">
			<iframe name="toppage" width=100% height="400px" marginwidth=0 marginheight=0 frameborder="no" border="0" scrolling="no"  src="<%=basePath%>rest/lineBoard/toChildone?requestType=mapuser" >
			</iframe>
			<iframe name="toppage" width=100% height="400px" marginwidth=0 marginheight=0 frameborder="no" border="0" scrolling="no"  src="<%=basePath%>rest/lineBoard/toChildtwo?requestType=mapuser" >
			</iframe>
		</div>
