...
<html>
	<head>
		...
		<script src="<%=basePath %>app/js/craManage/craProSeqRelationEdit.js" type="text/javascript"></script>
		<script>
	...
	<body style="padding:6px; overflow:hidden;">
		...
		<div class="l-loading" style="display:block" id="pageloading"></div> 
			<form id="craProSeqRelationManageListForm">
				...
				<div id="craProSeqRelationManageList" style="margin:0; padding:0"></div>
			</form>
