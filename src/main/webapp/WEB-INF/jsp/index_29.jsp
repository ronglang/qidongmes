...
<body style="padding:0px;background:#E0EEE0;">
	...
	<div id="layout1"
		...
		<div class="top"
			...
			<div class="top-a"
				style="float:left;width:100%;height: 290px;margin:0 auto; margin-top:0;margin-left:1px;background-color: #D6D6D6;">
					<!-- src="/smw/rest/carouselManageAction/carousel" scrolling="no"> -->
		...
		<div class="one" style="width: 100%;height:300px;margin:0 auto; margin-top:auto;background-color: #E0EEE0;">
			<div class="one-a" style="float:left;width:49.5%;height: 290px;margin:0 auto; margin-top:0;margin-left:1px;background-color: #D6D6D6;">
					<!-- <label>分类资产汇总</label> -->
						<%-- src="<%=basePath%>rest/macInformationManageAction/toClassifyCount" --%>
					<iframe style="width:100%;height: 290px;border: 0;"
							src="/test.jsp"
				...
				<!--  <label>分区域资产汇总</label>-->
<%-- 					src="<%=basePath%>rest/macInformationManageAction/macAreaInformationStateCount2" scrolling="no">  --%>
				<iframe style="width:100%;height: 290px;border: 0;"
						src="/test.jsp">
					</iframe>
			</div>
...
<%-- 								src="<%=basePath%>rest/macInformationManageAction/macAreaStateCount"> --%>
...
<%-- 					src="<%=basePath%>rest/macInformationManageAction/toShowEchartLine"> --%>
				<iframe style="width:100%;height: 290px;border: 0;" scrolling="no"
						src="/test.jsp">
				</iframe>
			</div>
</div>
		<div class="two-a" style="width:100%;height: 290px;margin:0 auto; margin-top:0;margin-left:1px;margin-right:1px;background-color: #D6D6D6;">
				<!-- <label>最近7天资产更新状态</label> -->
<%-- 					src="<%=basePath%>rest/macStateHisManageAction/tomacStatePage?pagename=main"> --%>
				<iframe style="width:100%;height: 290px;border: 0;" scrolling="no" align="middle"
						src="/test.jsp">
				</iframe>
			</div>
	</div>
