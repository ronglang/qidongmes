...
<title>质量回溯--详情</title>
<link
	href="<%=basePath %>app/js/lib/ligerUI/skins/Aqua/css/ligerui-all.css"
	rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" id="mylink" />
<script src="<%=basePath %>app/js/lib/jquery/jquery-1.9.0.min.js"
	type="text/javascript"></script>
<script src="<%=basePath %>app/js/lib/ligerUI/js/ligerui.all.js"
	type="text/javascript"></script>
...
#pageloading {
	...
	left: 0px;
	top: 0px;
	background: white url('<%=basePath %>app/js/lib/images/loading.gif')
		no-repeat center;
	width: 100%;
	height: 100%;
	z-index: 99999;
...
<body style="overflow: auto">
	...
	<div id="layout1" style="width:99.2%; margin: auto; margin-top:4px;">
		<div class="one"
			style="width: 100%;height:300px;margin:0 auto; margin-top:1px;background-color: #E0EEE0;">
			<div class="one-a"
				style="float:left;width:100%;height: 290px;margin:0 auto; margin-top:0;margin-left:0;background-color: #D6D6D6;">
				<iframe style="width:100%;height: 290px;border: 0;" scrolling="no"
					src="<%=basePath %>/rest/mauProcessSamplingManageAction/toCraParamDetailTable?seqname=${seqname}&maccode=${maccode}">
				</iframe>
			</div>
		</div>
		<div class="two"
			style="width: 100%;height:300px;margin:0 auto; margin-top:0;background-color: #E0EEE0;">
			<div class="two-a"
				style="float:left;width:100%;height: 290px;margin:0 auto; margin-top:1px;margin-left:0;background-color: #D6D6D6;">
				<iframe style="width:100%;height: 290px;border: 0;" scrolling="no"
					src="<%=basePath %>/rest/mauProcessSamplingManageAction/toBackDateMater?materid=${materid}&seqname=${seqname}">
				</iframe>
			</div>
		</div>
		<div
			style="height:32px; line-height:32px; text-align:center;margin-top: 1px">
