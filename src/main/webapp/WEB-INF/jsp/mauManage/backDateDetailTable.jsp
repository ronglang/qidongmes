    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                ...
                height: '100%',
                columns: [
				{ display: '机台编号', name: 'maccode', align: 'left', width: 100, minWidth: 10 },
                { display: '工单号', name: 'wscode', minWidth: 50 },
                ...
                onDblClickRow:function(rowdata, rowindex, rowDomElement){
            		...
            		var maccode = rowdata.maccode;
            		alert(maccode+","+seqname+","+materid+","+ccode+","+mpscode);
             		window.open("<%=basePath%>rest/mauProcessSamplingManageAction/toBackDateDetail?maccode="+maccode+"&seqname="+seqname+"&materid="+materid+"&ccode="+ccode+"&mpscode="+mpscode);
            	},
