...
<title>mauHandlingChoresList</title>
...
<script src="<%=basePath%>core/plugin/LigerUI/lib/ligerUI/js/plugins/ligerToolBar.js" type="text/javascript"></script>
...
<script src="<%=basePath %>app/js/mauManage/mauHandlingChoresList.js"
...
<body style="padding:6px; overflow:hidden;">
		...
		<div id="mauHandlingChoresManageList" style="margin:0; padding:0"></div>
</body>
</html>
