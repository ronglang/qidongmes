...
<div id="topmenu" class="l-topmenu">
    <div class="l-topmenu-logo">制程导航主页</div>
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px;overflow: hidden; "> 
        <div position="center" id="framecenter"> 
            <div id="home"  style="height:300p;overflow:hidden;">
                <iframe frameborder="0" name="home" id="home" src="<%=basePath %>/rest/mauProcessMonitoringManageAction/toMonitoringTable?productid=${productid}" scrolling="no"></iframe>
            </div> 
        </div> 
    </div>
