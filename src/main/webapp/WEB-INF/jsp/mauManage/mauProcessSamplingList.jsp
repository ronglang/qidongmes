...
<div id="topmenu" class="l-topmenu">
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px;overflow: hidden; "> 
        <div position="center" id="framecenter"> 
            <div id="home" title="生产过程"  style="height:300p;overflow:hidden;">
                <iframe frameborder="0" name="home" id="home" src="<%=basePath %>/rest/mauProcessSamplingManageAction/toBackDateTable?productid=${productid}" scrolling="no"></iframe>
            </div> 
            <div id="home" title="工艺参数"  style="height:300p;overflow:hidden;">
                <iframe frameborder="0" name="home" id="home" src="<%=basePath %>/rest/mauProcessSamplingManageAction/toCraParameter?productid=${productid}" scrolling="no"></iframe>
            </div>
        </div> 
    </div>
