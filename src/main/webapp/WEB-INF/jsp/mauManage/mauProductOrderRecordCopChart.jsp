...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            window['g'] =
            $("#maingrid").ligerGrid({
            	url:'<%=basePath %>rest/mauProductOrderRecordManageAction/getmauProductOrderRecordDate?time1=${time1}&time2=${time2}&batchCode=${batchCode}&objSort=${objSort}&objGgxh=${objGgxh}&address=${address}',
                height: '60%',
                columns: [
