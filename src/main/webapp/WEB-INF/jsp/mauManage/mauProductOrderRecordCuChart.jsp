...
<script>var basePath  = '<%=basePath%>';</script>
  ...
  <body>
  <div id="nav-a"><div id="number">1</div><span id="span-a">本周任务完成情况</span></div>
...
$(function() {
   	$.ajax({
   		type : "post"  ,
        async : false, //同步执行
        url : basePath+"rest/mauProductOrderRecordManageAction/getPineChartDate?requestType=mapuser",
  ...
  function myLoad(){
  	var basePath = "<%=basePath%>";
		...
		var url = "ws://"+urlPirfex+"productDepartmentPineWebSocket";
		    ...
		    series : [
		        {
		            ...
		            center: ['50%', '60%'],
		            data:[
		                {value:map.listMau[0], name:'已完成比例'},
		                {value:map.listPlan[0], name:'未完成比例'},
