...
<html>
	...
	<link href="<%=basePath %>core/plugin/LigerUI/lib/ligerUI/skins/Gray/css/all.css" rel="stylesheet" type="text/css" />
		...
		<script src="<%=basePath %>app/js/mauManage/mauRfidCardList.js" type="text/javascript"></script>
		<script>
...
<body style="padding:6px; overflow:hidden;">
	...
	<div id="mauRfidCardManageList" style="margin:0; padding:0"></div>
</body>
</html>
