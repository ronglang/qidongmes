...
<html>
  ...
  <body>
   		<div id="params" style="border:none;">
			<iframe style="border:none;" scrolling="no" id="PShow" name="PShow" src="<%=basePath%>rest/testWireDrawingAction/toPShow?requestType=portal"></iframe>
		</div>
		<div id="charts">
			<!-- 
			<iframe id="HSTest" src="<%=basePath%>rest/testWireDrawingAction/toHostSpeedTest"></iframe>
			 -->
			<iframe scrolling="no" id="MP" src="<%=basePath%>rest/testWireDrawingAction/toMProgress?requestType=portal"></iframe>
		</div>
		<div id="exception">
 				<h3>异常警告</h3>
 				<div class="content">
