	...
	<input type="hidden" name="id" id="hideId"  value="${id}"/>
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr class="l-table-edit-tr">
				<td align="right" class="l-table-edit-td">故障备注:</td>
		...
		<input class="l-button l-button-submit"  onclick="submitMauMachineFault()" type="button" value="提交" style="margin-right:90px;margin-top: 40px;" /> <input
