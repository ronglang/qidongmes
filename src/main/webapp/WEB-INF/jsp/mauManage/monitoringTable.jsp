    ...
    "seqName":"挤绝缘"},
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                ...
                height: '100%',
                columns: [
                { display: '产品编号', name: 'productid', align: 'left', width: 100, minWidth: 10 },
                { display: '产品合格', name: 'isqualified', minWidth: 30 },
                { display: '采样日期', name: 'sampldate', minWidth: 30 },
                { display: '当前轴号', name: 'ownaxisnumber' },
                { display: '来源轴号', name: 'sourceaxisnumber' },
                { display: '工作单号',name:'wscode',minWidth:30},
                { display: '工序名称',name:'seqname',minWidth:30},
                { display: '机台编号',name:'maccode',minWidth:30}
                ],  
