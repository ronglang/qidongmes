  ...
  <head>
	...
	var basePath = "<%=basePath%>";
		$(function(){
			...
			var url = basePath+'rest/mauReplacementManageAction/getMaterialList';
    		gridUi(url);
    	...
    	function sartch(){
    		...
    		var url = basePath+'rest/mauReplacementManageAction/getMaterialList?param='+param;
    		gridUi(url);
    	...
    	function gridUi(url){
    		manage = $("#maingrid").ligerGrid({
    			...
    			columns:[
    				...
    				{display: '领料时间',name:'materialTime'},
    				{display: '领料数量',name:'materialNumber'},
    				{display: '领料用途',name:'materialUse'},
    				{display: '领料人',name:'materialBy'},
  ...
  <body>
    ...
    <ul id="head">
		...
		<li style="width:40%;">
			...
			<span class="selected" id="material">领料记录</span>
		</li>
		<li></li>
	</ul>
