...
<%
	...
	String plaCapacityReport_id = request.getParameter("id");
%>
...
<title>plaCapacityReportEdit</title>
...
<script>
	...
	var routeName = "plaCapacityReportManage"; 
	var row_id = "";
	row_id =<%=plaCapacityReport_id%>;
</script>
...
<script src="<%=basePath%>app/js/plaManage/plaCapacityReportEdit.js" type="text/javascript"></script>
<!-- 默认引用end -->

</head>

<body>
	<form id="plaCapacityReportManage" method="post">
		<div></div>
