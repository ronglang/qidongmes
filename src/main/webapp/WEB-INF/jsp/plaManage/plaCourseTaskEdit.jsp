...
<script src="<%=basePath%>app/js/plaManage/plaCourseTaskEdit.js" type="text/javascript"></script>
<!-- 默认引用end -->

</head>

<body>
	<form id="plaCourseTaskManage" method="post">
		<div></div>
