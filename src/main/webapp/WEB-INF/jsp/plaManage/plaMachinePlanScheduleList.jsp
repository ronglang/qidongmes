...
<head>
    ...
    <script src="<%=basePath %>app/js/plaManage/lib/ligerUI/js/ligerui.all.js" type="text/javascript"></script>  
    <script src="<%=basePath %>app/js/plaManage/lib/jquery.cookie.js"></script>
    <script src="<%=basePath %>app/js/plaManage/lib/json2.js"></script>
    <script src="<%=basePath %>app/js/indexdata.js" type="text/javascript"></script>
        <script type="text/javascript">
            ...
            var skin_links = {
                "aqua": "<%=basePath %>app/js/lib/ligerUI/skins/Aqua/css/ligerui-all.css",
                "gray": "<%=basePath %>app/js/lib/ligerUI/skins/Gray/css/all.css",
                "silvery":"<%=basePath %>app/js/lib/ligerUI/skins/Silvery/css/style.css",
                "gray2014":"<%=basePath %>app/js/lib/ligerUI/skins/gray2014/css/all.css"
            };
            function pages_init()
            {
...
<style type="text/css"> 
    ...
    .l-topmenu-logo{ color:#E7E7E7; padding-left:35px; line-height:100px;}
...
<div id="topmenu" class="l-topmenu">
    <div class="l-topmenu-logo">质量回溯主页</div>
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px;overflow: hidden; "> 
        <div position="center" id="framecenter"> 
            <div id="home" title="机台计划进度"  style="height:300p;overflow:hidden;">
                <iframe frameborder="0" name="home" id="home" src="<%=basePath %>/rest/plaMachinePlanScheduleManageAction/toPlaMachinePlanScheduleTable?productcraft=${productcraft}" scrolling="no"></iframe>
            </div> 
            <!-- <div id="home" title="工艺参数"  style="height:300p;overflow:hidden;">
                <iframe frameborder="0" name="home" id="home" src="https://www.baidu.com/" scrolling="no"></iframe>
            </div> -->
        </div> 
    </div>
