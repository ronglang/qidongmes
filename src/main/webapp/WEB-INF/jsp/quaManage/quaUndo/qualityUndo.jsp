...
<html>
	...
	<link href="<%=basePath %>core/plugin/LigerUI/lib/ligerUI/skins/Gray/css/all.css" rel="stylesheet" type="text/css" />
		...
		<script src="<%=basePath %>app/js/quaundoManage/qualityUndo.js" type="text/javascript"></script>
		<script>
			var basePath  = '<%=basePath%>';
			var routeName = "qualityUndoManage";    
    	</script>
    	<style type="text/css">
    		#sort{
		  		border:none;
...
<body style="padding:6px; overflow:hidden;">
	...
	<div id="qualityUndoList" style="margin:0; padding:0"></div>
</body>
</html>
