...
<html>
	...
	<body style="padding:6px; overflow:hidden;">
		<div id="head">
			...
			<label class="l-icon-down" style="width:100px;margin-left:10px;" onclick="decomposition()">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label><label class="chagetext" onclick="startPickging()">分解</label>
			<!-- <label class="l-icon-logout" style="width:100px;margin-left:10px;" onclick="goToList()">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label><label class="chagetext" onclick="goToList()">通知单列表</label> -->
			<!-- <label id="headtitle">合同管理</label> -->
		</div>
		<div style="width:100%;height:100%;">
			<div id="serchdiv" style="height:30px;">
