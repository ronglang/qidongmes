...
<%
	...
	String storeObj_id = request.getParameter("id");
%>
...
<script src="<%=basePath%>app/js/storeManage/storeObjEdit.js" type="text/javascript"></script>
<!-- 默认引用end -->

</head>

<body>
	<form id="storeObjManage" method="post">
		<div></div>
