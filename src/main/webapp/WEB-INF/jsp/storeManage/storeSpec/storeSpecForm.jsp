...
<html>
  <head>
    ...
    <title>My JSP 'storeSpecForm.jsp' starting page</title>
	...
	<script type="text/javascript" src="<%=basePath%>app/js/storeManage/storeSpec/storeSpecList.js"></script>
  </head>
