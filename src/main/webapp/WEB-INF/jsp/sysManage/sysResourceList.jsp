...
<html>
	<head>
		...
		<script src="<%=basePath %>app/js/sysManage/sysResourceList.js" type="text/javascript"></script>
		<script>
	...
	<body style="padding:6px; overflow:hidden;">
		...
		<div class="l-loading" style="display:block" id="pageloading"></div> 
			<form id="sysResourceManageListForm">
				...
				<div id="sysResourceManageList" style="margin:0; padding:0"></div>
			</form>
