...
<html>
	<head>
		...
		<title>sysRoleResourceForm</title>
	...
	<body>
		<form id="SysRoleResource">
			<div></div>
			<a href="javascript:history.go(-1)" class="return">返&nbsp;回</a>
			<table>
				<tr><td>：</td><td><label id="RESOURCE_ID" ></label></td></tr><tr><td>：</td><td><label id="ROLE_ID" ></label></td></tr><tr><td>：</td><td><label id="ID" ></label></td></tr>
			</table>
		</form>
	</body>
