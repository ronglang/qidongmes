...
<html>
	<head>
		...
		<title>sysRoleResourceList</title>
		...
		<script src="<%=basePath %>app/js/sysManage/sysRoleResourceList.js" type="text/javascript"></script>
		<script>
	...
	<body style="padding:6px; overflow:hidden;">
		...
		<div class="l-loading" style="display:block" id="pageloading"></div> 
			<form id="sysRoleResourceManageListForm">
				...
				<div id="sysRoleResourceManageList" style="margin:0; padding:0"></div>
			</form>
