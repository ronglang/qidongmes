...
<html>
	<head>
		...
		<title>sysTelLocationList</title>
		...
		<script src="<%=basePath %>app/js/sysManage/sysTelLocationList.js" type="text/javascript"></script>
		<script>
	...
	<body style="padding:6px; overflow:hidden;">
		...
		<div class="l-loading" style="display:block" id="pageloading"></div> 
			<form id="sysTelLocationManageListForm">
				...
				<div id="sysTelLocationManageList" style="margin:0; padding:0"></div>
			</form>
