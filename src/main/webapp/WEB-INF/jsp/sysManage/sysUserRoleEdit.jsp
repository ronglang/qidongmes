...
<%
	...
	String sysUserRole_id = request.getParameter("id");
%>
...
<script>
	...
	var routeName = "sysUserRoleManage"; 
	var row_id = "";
	row_id =<%=sysUserRole_id%>;
</script>
...
<script src="<%=basePath%>app/js/sysManage/sysUserRoleEdit.js" type="text/javascript"></script>
<!-- 默认引用end -->

</head>

<body>
	<form id="sysUserRoleManage" method="post">
		<div></div>
		<table cellpadding="0" cellspacing="0" class="l-table-edit" >
			<tr class="l-table-edit-tr" ><td align="right" class="l-table-edit-td">：</td><td align="left" class="l-table-edit-td-input"><input id="USER_ID" name="USER_ID" type="text" ltype="text"/></td><td align="left"></td><td align="right" class="l-table-edit-td">：</td><td align="left" class="l-table-edit-td-input"><input id="ROLE_ID" name="ROLE_ID" type="text" ltype="text"/></td><td align="left"></td></tr>
		</table>
