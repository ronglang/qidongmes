...
<html>
	<head>
		...
		<script src="<%=basePath %>app/js/sysManage/sysUserRoleList.js" type="text/javascript"></script>
		<script>
	...
	<body style="padding:6px; overflow:hidden;">
		...
		<div class="l-loading" style="display:block" id="pageloading"></div> 
			<form id="sysUserRoleManageListForm">
				...
				<div id="sysUserRoleManageList" style="margin:0; padding:0"></div>
			</form>
