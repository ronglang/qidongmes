...
<html>
  <head>
	...
	$(document).ready(function(){
		...
		$("#start").ligerDateEditor({format:'yyyy-MM-dd hh:mm:ss',showTime:true,width:180,height:25});
	...
	function grid(){
	    ...
	    $("#maingrid").ligerGrid({
	        height: '90%',
	        title:'仓库查询  &rarr; 出入库查询  &rarr; 成品列表(一段时间出入库统计，默认7天)',
	...
	<div id="t_select" style="margin-top:0px;">
		...
		<div class="con" style="height:100px;">
			<div class="con_div">
				...
				<span>成品名称：</span><input type="text" name="" style="margin-right:20px" id="name"/>
				<span>成品颜色：</span><input type="text" name="" id="color"/><br/>
