  ...
  <head>
    ...
    <script type="text/javascript">
    	...
    	function grid(){
    	    ...
    	    $("#maingrid").ligerGrid({
    	        height: '92%',
    	        title:'仓库查询  &rarr; 库存查询  &rarr; 原材料列表(当前库存)',
    	        url: basePath+'rest/statStoreObjVoManageAction/getAllStore?param='+param,
    	       	
    	        columns: [
	    			{ display: '原料规格', name: 'ggxh'},
	    	        { display: '原料名称', name: 'name2'},
	    	        { display: '原料颜色', name: 'color'},
  ...
  <body>
	...
	<div id="t_select" style="margin-top:0px;">
		...
		<div class="con">
			...
			<div class="con_div">
				<span>原料规格：</span><input type="text" name="" style="margin-right:20px" id="ggxh" >
				<span>原料颜色：</span><input type="text" name="" id="color" />
