...
<html>
  <head>
	...
	function grid(){
	    ...
	    $("#maingrid").ligerGrid({
	        height: '90%',
	        title:'仓库查询  &rarr; 出入库查询  &rarr; 半成品列表(一段时间出入库统计，默认7天)',
	        url: basePath+'rest/statStoreObjVoManageAction/getAllStore?param='+param,
	       	checkbox: true,
	        columns: [
    			{ display: '半成品规格', name: 'ggxh'},
    	        { display: '半成品名称', name: 'name2'},
    	        { display: '半成品颜色', name: 'color'},
  ...
  <body>
	...
	<div id="t_select" style="margin-top:0px;">
		...
		<ul class="nav">
	        <li class="drop-down">
	        	 <a><span id="semi_over_product">半成品查询</span><span class="arrow-down"></span></a>
		...
		<div class="con" style="height:100px;">
			<div class="con_div">
				<span>半成品规格：</span><input type="text" name="" style="margin-right:20px" id="ggxh">
				<span>半成品名称：</span><input type="text" name="" style="margin-right:20px" id="name"/>
				<span>半成品颜色：</span><input type="text" name="" id="color"/><br/>
