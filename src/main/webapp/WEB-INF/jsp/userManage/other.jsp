...
<link href="<%=basePath%>core/plugin/LigerUI/lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" />
	...
	var basePath  = '<%=basePath%>';
 	...
 	<script src="<%=basePath%>app/js/userManage/test.js" type="text/javascript"></script>
    <style type="text/css">
        .l-table-edit {}
...
<body>
    <form name="form1" method="post"  id="testform1">
...
<input type="button" value="openwindow" onclick="openWindowDialog();" class="l-button"/>
    </form>
