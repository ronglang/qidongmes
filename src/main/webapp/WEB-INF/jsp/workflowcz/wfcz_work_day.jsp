...
<link rel="stylesheet" href="../jslib/jqueryUI1.10.4/themes/base/jquery.ui.base.css" />
<link rel="stylesheet" href="../jslib/jqueryUI1.10.4/themes/base/jquery.ui.theme.css" />
<link rel="stylesheet" href="../jslib/jqueryUI1.10.4/themes/base/jquery.ui.datepicker2.css" />
<script type="text/javascript" src="../jslib/jquery-easyui/jquery-1.7.2.min.js"></script>
<script src="../jslib/jqueryUI1.10.4/ui/jquery.ui.core.js"></script>
<script src="../jslib/jqueryUI1.10.4/ui/jquery.ui.widget.js"></script>
<script src="../jslib/jqueryUI1.10.4/ui/jquery.ui.datepicker.js"></script>
...
$(function() {
	...
	*/
	...
	$("#olookup").click(function (){
		if(confirm('确实要保存'+global_now_year+'的日期设置吗？')){
			//showloading();
...
<!-- 
			<input type="button" id="oyearup" name="lookup" value="&lt;&lt;上一年" class="But" />
			<span id="todayYear" style="color: #FF0000; font-weight: bold;"></span>
			<input type="button" id="oyeardown" name="lookup" value="下一年&gt;&gt;" class="But" />
			<input type="button" id="olookup" name="lookup" value="保存工作日设置" class="But" />
 -->			
			<table class="datepicker_table" style="padding:0 0 0 0" border="0" >
			 <tr>
				 <td><span id="datepicker1" ></span></td>
				 <td><span id="datepicker2" ></span></td>
				 <td><span id="datepicker3" ></span></td>
				 <td><span id="datepicker4" ></span></td>
			 </tr>
			 <tr>
				 <td><span id="datepicker5" ></span></td>
				 <td><span id="datepicker6" ></span></td>
				 <td><span id="datepicker7" ></span></td>
				 <td><span id="datepicker8" ></span></td>
			 </tr>
			 <tr>
				 <td><span id="datepicker9" ></span></td>
				 <td><span id="datepicker10" ></span></td>
				 <td><span id="datepicker11" ></span></td>
				 <td><span id="datepicker12" ></span></td>
			 </tr>
			</table> 
		</div>
	</div>
