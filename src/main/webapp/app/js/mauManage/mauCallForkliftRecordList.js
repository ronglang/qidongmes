...
$(function ()
    {
		...
		grid=$("#mauCallForkliftRecordManageList").ligerGrid({
			url : basePath + "rest/"+ routeName + "Action/dataGridPage",
	        checkbox: true,
	        columns: [
	            { display: '序号', name: 'id',  width: 120 },{ display: '', name: 'createDate',  width: 120 },{ display: '', name: 'createBy',  width: 120 },{ display: '', name: 'mcfrCode',  width: 120 },{ display: '呼叫人编号', name: 'callBy',  width: 120 },{ display: '呼叫时间', name: 'callTime',  width: 120 },{ display: '应答人编号', name: 'replyBy',  width: 120 },{ display: '应答时间', name: 'replyTime',  width: 120 },{ display: '叉车编号', name: 'fCode',  width: 120 },
		        {
		...
		$("#add").click(function(){
			top.$.ligerDialog.open({ 
				url: basePath+"rest/mauCallForkliftRecordManageAction/toAddEditPage", 
				height: 600,
				width: 1080,
				modal:true,
				title:"添加"
...
function edit(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/mauCallForkliftRecordManageAction/toAddEditPage?id="+id, 
		height: 600,
		width: 1080,
		modal:true, 
		title:"编辑"
...
function show(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/mauCallForkliftRecordManageAction/toDetailPage?id="+id, 
		height: 600,
		width: 1080,
		modal:true, 
		title:"详细信息"
