...
$(function ()
    {
		...
		grid=$("#mauProductBomManageList").ligerGrid({
			url : basePath + "rest/"+ routeName + "Action/dataGridPage",
	        checkbox: true,
	        columns: [
	            { display: '序号', name: 'id',  width: 120 },{ display: '', name: 'createDate',  width: 120 },{ display: '', name: 'createBy',  width: 120 },{ display: '', name: 'mpbCode',  width: 120 },{ display: '产品BOM名称', name: 'mpbName',  width: 120 },{ display: '', name: 'specifications',  width: 120 },{ display: '颜色，应该是一个枚举值', name: 'color',  width: 120 },{ display: '产品编号', name: 'productCode',  width: 120 },{ display: '产品工艺表code', name: 'productC_code',  width: 120 },
		        {
		...
		$("#add").click(function(){
			top.$.ligerDialog.open({ 
				url: basePath+"rest/mauProductBomManageAction/toAddEditPage", 
				height: 600,
				width: 1080,
				modal:true,
				title:"添加"
...
function edit(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/mauProductBomManageAction/toAddEditPage?id="+id, 
		height: 600,
		width: 1080,
		modal:true, 
		title:"编辑"
...
function show(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/mauProductBomManageAction/toDetailPage?id="+id, 
		height: 600,
		width: 1080,
		modal:true, 
		title:"详细信息"
