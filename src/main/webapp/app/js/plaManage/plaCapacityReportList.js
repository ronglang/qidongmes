...
$(function ()
    {
		...
		grid=$("#plaCapacityReportManageList").ligerGrid({
			url : basePath + "rest/"+ routeName + "Action/dataGridPage",
	        checkbox: true,
	        columns: [
	            { display: '序号', name: 'id',  width: 120 },{ display: '', name: 'createDate',  width: 120 },{ display: '', name: 'createBy',  width: 120 },
		        {
		...
		$("#add").click(function(){
			top.$.ligerDialog.open({ 
				url: basePath+"rest/plaCapacityReportManageAction/toAddEditPage", 
				height: 600,
				width: 1080,
				modal:true,
				title:"添加"
...
function edit(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/plaCapacityReportManageAction/toAddEditPage?id="+id, 
		height: 600,
		width: 1080,
		modal:true, 
		title:"编辑"
...
function show(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/plaCapacityReportManageAction/toDetailPage?id="+id, 
		height: 600,
		width: 1080,
		modal:true, 
		title:"详细信息"
