...
$(function ()
    {
		...
		grid=$("#plaCourseTaskManageList").ligerGrid({
		...
		$("#add").click(function(){
			top.$.ligerDialog.open({ 
				url: basePath+"rest/plaCourseTaskManageAction/toAddEditPage", 
				height: 600,
				width: 1080,
				modal:true,
				title:"添加"
...
function edit(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/plaCourseTaskManageAction/toAddEditPage?id="+id, 
		height: 600,
		width: 1080,
		modal:true, 
		title:"编辑"
...
function show(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/plaCourseTaskManageAction/toDetailPage?id="+id, 
		height: 600,
		width: 1080,
		modal:true, 
		title:"详细信息"
