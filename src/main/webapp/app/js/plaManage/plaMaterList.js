...
$(function ()
    {
		...
		grid=$("#plaMaterManageList").ligerGrid({
			url : basePath + "rest/"+ routeName + "Action/dataGridPage",
	        checkbox: true,
	        columns: [
	            { display: '', name: 'id',  width: 120 },{ display: '计划明细ID', name: 'detailId',  width: 120 },{ display: '材料id', name: 'materId',  width: 120 },{ display: '', name: 'amount',  width: 120 },{ display: '单位，数量', name: 'unit',  width: 120 },
		        {
		...
		$("#add").click(function(){
			top.$.ligerDialog.open({ 
				url: basePath+"rest/plaMaterManageAction/toAddEditPage", 
				height: 600,
				width: 1080,
				modal:true,
				title:"添加"
...
function edit(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/plaMaterManageAction/toAddEditPage?id="+id, 
		height: 600,
		width: 1080,
		modal:true, 
		title:"编辑"
...
function show(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/plaMaterManageAction/toDetailPage?id="+id, 
		height: 600,
		width: 1080,
		modal:true, 
		title:"详细信息"
