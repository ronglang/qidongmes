...
$(function ()
    {
		...
		grid=$("#sysRoleResourceManageList").ligerGrid({
			url : basePath + "rest/"+ routeName + "Action/dataGridPage",
	        checkbox: true,
	        columns: [
	            { display: '', name: 'resourceId',  width: 120 },{ display: '', name: 'roleId',  width: 120 },{ display: '序号', name: 'id',  width: 120 },
		        {
		...
		$("#add").click(function(){
			top.$.ligerDialog.open({ 
				url: basePath+"rest/sysRoleResourceManageAction/toAddEditPage", 
				height: 600,
				width: 1000,
				modal:true, 
...
function edit(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/sysRoleResourceManageAction/toAddEditPage?id="+id, 
		height: 600,
		width: 900,
		modal:true, 
		/*buttons: [ { text: '确定', onclick: function (item, dialog) { 
...
function show(id){
	top.$.ligerDialog.open({ 
		url: basePath+"rest/sysRoleResourceManageAction/toDetailPage?id="+id, 
		height: 600,
		width: 900,
		modal:true, 
		/*buttons: [
