...
(function ($)
{
    $.fn.ligerTimeEditor = function ()
    {
        return $.ligerui.run.call(this, "ligerTimeEditor", arguments);
    };

    $.fn.ligerGetTimeEditorManager = function ()
    {
        return $.ligerui.run.call(this, "ligerGetTimeEditorManager", arguments);
    };

    $.ligerDefaults.TimeEditor = {
    ...
    $.ligerDefaults.TimeEditorString = {
        dayMessage: ["日", "一", "二", "三", "四", "五", "六"],
        monthMessage: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"],
        todayMessage: "今天",
        closeMessage: "关闭"
    };
    $.ligerMethos.TimeEditor = {};

    $.ligerui.controls.TimeEditor = function (element, options)
    {
        $.ligerui.controls.TimeEditor.base.constructor.call(this, element, options);
    };
    $.ligerui.controls.TimeEditor.ligerExtend($.ligerui.controls.Input, {
        __getType: function ()
        {
            return 'TimeEditor';
        },
